...
class Binner():
    ...
    def __init__(self, signal_sample: Sample, set_params: dict):
        ...
        self.binning_map = {
            ...
            "defaults": {
                "MET": [220,270,320,370,420,520,620,820,10000],
                "m_H": [200,300,400,500,600,700,800,1000,1200,1600,10000],
                "mt_A": [500,600,700,800,900,1000,1200,1400,1800,2200,10000],
                "jetsAk4CHS.m_phi_1": np.linspace(-3.14, 3.14, 10),
                "jetsAk4CHS.m_phi_2": np.linspace(-3.14, 3.14, 10),
                "jetsAk4CHS.m_pt_1": [30,60,90,120,220,420,10000],
                "jetsAk4CHS.m_pt_2": [30,60,90,120,220,420,10000],
                "jetsAk4CHS.m_eta_1": np.linspace(-2.4, 2.4, 9),
                "jetsAk4CHS.m_eta_2": np.linspace(-2.4, 2.4, 9),
                "b_phi": np.linspace(-3.14, 3.14, 10),
                "b_pt": [30,60,90,120,220,420,10000],
                "b_eta": np.linspace(-2.4, 2.4, 9),
                "num_j": [5,6,7,8,9],
                "num_l": [0,1,2,3,4,5],
                "num_b": [0,1,2,3,4,5],
                "HT": [200,300,400,500,700,900,1200,1500,10000],
