...
class Binner():
    ...
    binning_map = {
        ...
        "defaults": {
            ...
            "jetsAk4CHS.m_pt_1": np.linspace(30, 650, 16),
            "jetsAk4CHS.m_pt_2": np.linspace(30, 650, 16),
            "jetsAk4CHS.m_pt_3": np.linspace(30, 650, 16),
            "jetsAk4CHS.m_pt_4": np.linspace(30, 650, 16),
            ...
            "MET": np.append(list(range(220,800+1,20)),10000),
