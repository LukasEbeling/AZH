...
WHITELIST = {
    ...
    "CMS_btag_light": "todo",
    "CMS_pu": "todo",
    "CMS_trigger_sf_ee": "todo",
    "CMS_trigger_sf_emu": "todo",
    "CMS_trigger_sf_mumu": "todo",
    "CMS_sfelec_reco": "todo",
    "CMS_sfelec_tight_id": "todo",
    "CMS_sfmu_isolation": "todo",
    "CMS_sfmu_tight_id": "todo",
    "CMS_toppt_a": "weight_toppt_a",
    "CMS_toppt_b": "weight_toppt_b",
    # "CMS_scale_j_Total": "todo",
    "CMS_scale_j_Absolute": "todo",
    "CMS_scale_j_BBEC1": "todo",
    "CMS_scale_j_EC2": "todo",
    "CMS_scale_j_FlavorQCD": "todo",
    "CMS_scale_j_HF": "todo",
    "CMS_scale_j_RelativeBal": "todo",
    "CMS_scale_j_Absolute_YEAR": "todo",
    "CMS_scale_j_BBEC1_YEAR": "todo",
    "CMS_scale_j_EC2_YEAR": "todo",
    "CMS_scale_j_HF_YEAR": "todo",
    "CMS_scale_j_RelativeSample_YEAR": "todo",
    "CMS_res_j": "todo",
    "CMS_mur_AtoZH": "weight_mur",
    "CMS_muf_AtoZH": "weight_muf",
    "CMS_mur_ZJets": "weight_mur",
    "CMS_muf_ZJets": "weight_muf",
    "CMS_mur_TT": "weight_mur",
    "CMS_muf_TT": "weight_muf",
    "CMS_mur_TTZ": "weight_mur",
    "CMS_muf_TTZ": "weight_muf",
    "CMS_mur_SingleTop": "weight_mur",
    "CMS_muf_SingleTop": "weight_muf",
    "CMS_mur_TTW": "weight_mur",
    "CMS_muf_TTW": "weight_muf",
    "CMS_mur_VV": "weight_mur",
    "CMS_muf_VV": "weight_muf",
    "CMS_mur_WJets": "weight_mur",
    "CMS_muf_WJets": "weight_muf",
    "CMS_mur_QCD": "weight_mur",
    "CMS_muf_QCD": "weight_muf",
    "fsr_2": "weight_fsr_2",
    "isr_2": "weight_isr_2",
    "pdf_AtoZH": "todo",
    "pdf_ZJets": "todo",
...
SHAPES_NP = {
    ...
    "CMS_pu": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_trigger_sf_ee": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_trigger_sf_emu": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_trigger_sf_mumu": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_sfelec_reco": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_sfelec_tight_id": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_sfmu_isolation": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_sfmu_tight_id": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_toppt_a": ["AtoZH", "TT", "TTW", "TTZ"],
    "CMS_toppt_b": ["AtoZH", "TT", "TTW", "TTZ"],
    # "CMS_scale_j_Total": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_scale_j_Absolute": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_scale_j_BBEC1": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_scale_j_EC2": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_scale_j_FlavorQCD": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_scale_j_HF": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_scale_j_RelativeBal": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_scale_j_Absolute_YEAR": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_scale_j_BBEC1_YEAR": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_scale_j_EC2_YEAR": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_scale_j_HF_YEAR": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_scale_j_RelativeSample_YEAR": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_res_j": ["AtoZH", "ZJets", "SingleTop", "TT", "TTW", "TTZ", "VV", "WJets"],
    "CMS_mur_AtoZH": ["AtoZH"],
    "CMS_muf_AtoZH": ["AtoZH"],
    "CMS_mur_ZJets": ["ZJets"],
    "CMS_muf_ZJets": ["ZJets"],
...
class Datacard():
    ...
    def write_shape_systematics(self, f):
        for shape_np, applicable_processes in SHAPES_NP.items():
            if WHITELIST[shape_np] not in config.variations: continue
